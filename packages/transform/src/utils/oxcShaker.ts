...
import type { ReceiverOperation } from './oxcShaker/patternEffects';
import { createStatementGraphShaker } from './oxcShaker/statementGraph';

export type { OxcShakerResult } from './oxcShaker/statementGraph';
...
export const shakeOxcToESM = createStatementGraphShaker(
