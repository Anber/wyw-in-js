...
'@wyw-in-js/e2e-webpack': major
'@wyw-in-js/e2e-vite': major
'@wyw-in-js/e2e-rollup': major
'@wyw-in-js/e2e-parcel': major
'@wyw-in-js/e2e-next-webpack': major
'@wyw-in-js/e2e-next-turbopack': major
'@wyw-in-js/e2e-esbuild': major
'@wyw-in-js/e2e-bun': major
'vite-react-refresh-repro': major
'@wyw-in-js/template-tag-syntax': major
'rsbuild-issue-256-repro': major
