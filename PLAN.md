...
- Active task: `TASK-09-linaria-contract.md`
- Blocking questions: none
- Last verification: `bun run --filter @wyw-in-js/transform build:types`, `bun run --filter @wyw-in-js/transform lint`, `bun run check:ts-size`, and `bun test src/__tests__/oxc-preeval-stage.test.ts src/__tests__/oxc-collect-runtime.test.ts src/__tests__/transform.static-import-values.test.ts` passed on 2026-05-08.
